...
public class StringMethod {
    ...
    public void Test () {
        ...
        System.out.println(s1.toUpperCase());    //  HELLO WORLD  //这操作也并没有改变s1本身
        System.out.println(s1.trim());    //hello world
        String s2 = "  HELLO WORLD  ";
        System.out.println(s1.equalsIgnoreCase(s2));    //true
        String s3 = "!!!";
        System.out.println(s1.concat(s3));    //  hello world  !!!
        System.out.println(s1.compareTo(s2));    //32//码值相减得出结果//涉及到字符串排序
        System.out.println(s1.substring(2));    //hello world
        System.out.println(s1.substring(2, 7));    //hello//左闭右开
